...
const CreateServicePage = lazyRouteComponent(
  () => import('@domains/services/pages/CreateServicePage'),
  'CreateServicePage'
)
const EditServicePage = lazyRouteComponent(
  () => import('@domains/services/pages/EditServicePage'),
  'EditServicePage'
)
const ServicesTrashPage = lazyRouteComponent(
  () => import('@domains/services/pages/ServicesTrashPage'),
  'ServicesTrashPage'
)
