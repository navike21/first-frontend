...
export const ko: UsersTranslations = {
  page: {
    ...
    trashTitle: '휴지통 – 사용자',
    trashDescription: '휴지통으로 이동된 사용자입니다. 복원하거나 영구 삭제할 수 있습니다.',
  ...
  form: {
    ...
    groupId: '그룹', groupIdPlaceholder: '그룹 ID',
    addressSection: '주소',
    addressStreet: '도로명', addressStreetPlaceholder: '세종대로 1',
    addressCity: '시/군/구', addressCityPlaceholder: '서울시',
