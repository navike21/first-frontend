...
export const pt: UsersTranslations = {
  page: {
    ...
    trashDescription: 'Usuários movidos para a lixeira. Restaure-os ou exclua-os permanentemente.',
    trashEmpty: 'Nenhum usuário na lixeira',
    trashEmptyDescription: 'Quando usuários forem excluídos, eles aparecerão aqui.',
  },
  table: {
  ...
  form: {
    ...
    dateOfBirth: 'Data de nascimento', dateOfBirthPlaceholder: 'AAAA-MM-DD',
    uploadPhoto: 'Carregar foto', uploadFormats: 'Permitido *.jpeg, *.jpg, *.png — máx 3 MB',
    ...
    groupId: 'Grupo', groupIdPlaceholder: 'ID do grupo',
    addressSection: 'Endereço',
    addressStreet: 'Rua', addressStreetPlaceholder: 'Rua Principal, 123',
    addressCity: 'Cidade', addressCityPlaceholder: 'São Paulo',
    addressState: 'Estado / Região', addressStatePlaceholder: 'SP',
    addressCountry: 'País', addressCountryPlaceholder: 'Brasil',
    addressPostalCode: 'CEP', addressPostalCodePlaceholder: '01310-100',
    statusLabel: 'Status da conta', statusDescription: 'Usuários inativos não podem fazer login',
