...
export const ja: UsersTranslations = {
  page: {
    ...
    trashTitle: 'ゴミ箱 – ユーザー',
    trashDescription: 'ゴミ箱に移動されたユーザーです。復元または完全削除できます。',
  ...
  form: {
    ...
    groupId: 'グループ', groupIdPlaceholder: 'グループID',
    addressSection: '住所',
    addressStreet: '番地', addressStreetPlaceholder: '1-1 千代田',
    addressCity: '市区町村', addressCityPlaceholder: '千代田区',
