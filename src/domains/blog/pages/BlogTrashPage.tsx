...
import { useBlogTrashPage } from './BlogTrashPage.hooks'
...
export const BlogTrashPage = () => {
  ...
  return (
    ...
    >
      ...
      <BlogPostDetailModal item={viewing} onClose={() => setViewing(null)} />
