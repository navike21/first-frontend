...
export const it: MediaTranslations = {
  ...
  preview: {
    ...
    moduleServices: 'Servizio',
    modulePages: 'Pagina',
    moduleAppSettings: 'Impostazioni del sito',
    contextCover: 'copertina',
    contextGallery: 'galleria',
    contextOgImage: 'immagine social (SEO)',
    contextBackground: 'sfondo di sezione',
    contextLogo: 'logo',
