...
export const pt: SiteConfigTranslations = {
  page: {
    ...
    description:
      'Defina o layout global do site público: header, footer e área de conteúdo',
  },
  tabs: {
    header: 'Header',
    footer: 'Footer',
  ...
  maps: {
    hint: 'Escolha qual provedor de mapas o site público usará.',
    providerLabel: 'Provedor de mapas',
    providers: {
      google: 'Google Maps',
      osm: 'OpenStreetMap',
    },
  ...
  languages: {
    hint: 'Escolha em quais idiomas esta empresa publica seu conteúdo (páginas, serviços, portfólio, etc.) — independente do idioma que você usa no próprio First.',
    minimumHint: 'Pelo menos um idioma deve permanecer selecionado.',
  },
  actions: {
