...
export const fr: UsersTranslations = {
  page: {
    ...
    trashDescription: 'Utilisateurs déplacés dans la corbeille. Restaurez-les ou supprimez-les définitivement.',
  ...
  form: {
    ...
    groupId: 'Groupe', groupIdPlaceholder: 'ID du groupe',
    addressSection: 'Adresse',
    addressStreet: 'Rue', addressStreetPlaceholder: '1 rue de la Paix',
    addressCity: 'Ville', addressCityPlaceholder: 'Paris',
