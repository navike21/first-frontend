...
export const it: UsersTranslations = {
  ...
  form: {
    ...
    email: 'Email',
    emailPlaceholder: 'utente@navike21.com',
    password: 'Password',
    passwordPlaceholder: 'Minimo 8 caratteri',
    phone: 'Telefono',
    phonePlaceholder: '+39 999 999 9999',
    ...
    addressStreet: 'Via',
    addressStreetPlaceholder: 'Via Roma 1',
    addressCity: 'Città',
    addressCityPlaceholder: 'Roma',
    addressState: 'Regione',
    addressStatePlaceholder: 'Lazio',
    addressCountry: 'Paese',
    addressCountryPlaceholder: 'Italia',
    addressPostalCode: 'CAP',
    addressPostalCodePlaceholder: '00100',
