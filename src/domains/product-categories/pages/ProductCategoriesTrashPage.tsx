...
import { useProductCategoriesTrashPage } from './ProductCategoriesTrashPage.hooks'
...
export const ProductCategoriesTrashPage = () => {
  const {
    t,
    language,
    categories,
    ...
    },
    {
      ...
      cell: (category) => (
        <div className="flex items-center justify-end gap-1">
          ...
          <Can anyOf={CAN.productCategoriesPurge}>
            <Tooltip
      ...
      actions={[
        {
          ...
          variant: 'secondary',
          to: navPaths.productCategories(language),
          size: 'small',
        },
      ]}
    >
