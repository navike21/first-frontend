...
export const ru: PageTranslations = {
  ...
  builder: {
    ...
    mediaLibrary: {
      ...
      addSelectedLabel: 'Добавить выбранное',
      selectAllLabel: 'Выбрать все',
      selectItemLabel: 'Выбрать файл',
      previewLabel: 'Предпросмотр',
      closePreviewLabel: 'Закрыть предпросмотр',
    ...
    addButton: 'Кнопка',
    addGallery: 'Галерея',
    addAccordion: 'Вопросы',
    addTestimonials: 'Отзывы',
    addStats: 'Статистика',
    addVideo: 'Видео',
    addMap: 'Карта',
    textElement: 'Текст',
    ...
    galleryElement: 'Галерея',
    accordionElement: 'Часто задаваемые вопросы',
    testimonialsElement: 'Отзывы',
    statsElement: 'Статистика',
    videoElement: 'Встроенное видео',
    mapElement: 'Карта',
    ...
    sliderLibraryImage: 'Изображение из библиотеки',
    sliderLibraryVideo: 'Видео из библиотеки',
    buttonLabel: 'Текст кнопки',
    buttonUrl: 'URL ссылки',
    buttonEmpty: 'Нажмите «редактировать», чтобы настроить кнопку',
    buttonTargetLabel: 'Открывать ссылку в',
    buttonTargetSelf: 'Той же вкладке',
    buttonTargetBlank: 'Новой вкладке',
    buttonVariantLabel: 'Стиль',
    buttonVariant: {
      primary: 'Основной',
      secondary: 'Вторичный',
      outline: 'Контурный',
    },
    galleryEmpty: 'Добавить изображения',
    galleryAddLabel: 'Перетащите изображения сюда или нажмите, чтобы выбрать',
    galleryDragLabel: 'Отпустите, чтобы добавить',
    galleryFormatsHint: 'Изображения (JPEG, PNG, WebP)',
    galleryRemoveLabel: 'Удалить изображение',
    galleryLibraryLabel: 'Выбрать из библиотеки',
    galleryAlt: 'Альтернативный текст',
    accordionEmpty: 'Добавить вопросы',
    accordionAddLabel: 'Добавить вопрос',
    accordionQuestionLabel: 'Вопрос',
    accordionAnswerLabel: 'Ответ',
    accordionRemoveLabel: 'Удалить вопрос',
    accordionItemDragLabel: 'Перетащить вопрос',
    testimonialsEmpty: 'Добавить отзывы',
    testimonialsAddLabel: 'Добавить отзыв',
    testimonialsNameLabel: 'Имя',
    testimonialsRoleLabel: 'Должность',
    testimonialsQuoteLabel: 'Отзыв',
    testimonialsRatingLabel: 'Рейтинг',
    testimonialsRatingNone: 'Без рейтинга',
    testimonialsAvatarLabel: 'Фото',
    testimonialsRemoveLabel: 'Удалить отзыв',
    testimonialsItemDragLabel: 'Перетащить отзыв',
    statsEmpty: 'Добавить статистику',
    statsAddLabel: 'Добавить показатель',
    statsValueLabel: 'Значение',
    statsLabelLabel: 'Подпись',
    statsRemoveLabel: 'Удалить показатель',
    statsItemDragLabel: 'Перетащить показатель',
    videoUrlLabel: 'URL видео (YouTube, Vimeo…)',
    videoUrlHint: 'Вставьте ссылку на видео, размещённое на внешнем сервисе',
    videoCaptionLabel: 'Описание (необязательно)',
    videoEmpty: 'Нажмите «редактировать», чтобы настроить видео',
    videoSourceLabel: 'Источник видео',
    videoSourceLibrary: 'Из галереи',
    videoSourceEmbed: 'URL для встраивания',
    videoFromLibrary: 'Видео из галереи',
    videoFile: 'Видео',
    videoChoose: 'Выбрать видео',
    videoReplace: 'Заменить видео',
    videoRemove: 'Удалить видео',
    mapAddressLabel: 'Адрес',
    mapLatLabel: 'Широта (необязательно)',
