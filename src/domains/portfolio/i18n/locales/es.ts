...
export const es: PortfolioTranslations = {
  page: {
    ...
    trashDescription: 'Proyectos eliminados — restáuralos o elimínalos permanentemente',
    trashEmpty: 'La papelera está vacía',
    trashEmptyDescription: 'No hay proyectos eliminados.',
  },
  table: {
  ...
  actions: {
    ...
    bulkRestoreDescription: (count) => `¿Restaurar ${count} proyectos?`,
    purgeTitle: 'Eliminar permanentemente',
    purgeDescription: (name) => `¿Eliminar permanentemente "${name}"? Esta acción no se puede deshacer.`,
    confirmPurge: 'Eliminar permanentemente',
    bulkPurgeDescription: (count) => `¿Eliminar permanentemente ${count} proyectos? Esta acción no se puede deshacer.`,
  },
  form: {
