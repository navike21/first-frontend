...
const translations: Record<string, Record<string, string>> = {
  es: {
    title: 'Servicios',
    desc: 'Módulo de gestión de servicios',
    construction: 'Este módulo se encuentra en construcción.',
    sub: 'Próximamente podrás gestionar tus servicios profesionales aquí.',
  },
  en: {
    title: 'Services',
    desc: 'Services management module',
    construction: 'This module is currently under construction.',
    sub: 'Soon you will be able to manage your professional services here.',
  },
}
