...
export const FormSubmissionDetailModal = ({
  ...
  return (
    <Modal isOpen={!!submission} onClose={onClose} size="lg" title={t.submissionDetail.title}>
      {submission && (
        <div className="space-y-5">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <DetailField label={t.submissionDetail.submittedAt} value={formatDate(submission.createdAt)} />
            <DetailField label={t.submissionDetail.ipAddress} value={submission.ipAddress} />
            <DetailField label={t.submissionDetail.userAgent} value={submission.userAgent} />
          </div>
