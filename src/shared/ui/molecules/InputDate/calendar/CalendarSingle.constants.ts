...
export const DAY_PICKER_CLASS_NAMES = {
  ...
  range_middle: [
    ...
    '[&>button]:aria-selected:text-(--text-primary)',
...
export const CAPTION_BTN_CLS = clsx(
  'rounded-sm px-1.5 py-0.5 text-sm font-semibold text-(--text-primary)',
...
export const NAV_BTN_CLS = clsx(
  ...
  'text-(--text-secondary) transition-colors duration-fast ease-out-expo',
