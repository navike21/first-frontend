...
export const HelperTextAsReactNode: Story = {
  args: {
    label: 'Rich Helper',
    placeholder: 'Enter text',
    leftSlot: <IconComponent icon="RiInformation2Line" className="text-slate-500" />,
    helperText: (
      <div>
  ...
  render: (args) => {
    ...
    return (
      <div className="grid grid-cols-2 gap-6 max-w-md w-full">
        ...
        <InputField {...otherArgs} label="Loading State" placeholder="Loading" loading />
        <InputField {...otherArgs} label="Disabled State" placeholder="Disabled" disabled />
        <InputField
          {...otherArgs}
          label="Error State"
          placeholder="Error"
